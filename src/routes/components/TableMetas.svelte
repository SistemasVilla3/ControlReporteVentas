<script lang="ts">
	...
	const API_ACT_MET = 'http://192.168.10.134:4018/InsertMeta';
		...
		<table class="w-full rounded-md">
			<thead>
				<tr class="sticky top-0 z-10 rounded-md bg-red-800">
					<th
						class="text-white-900 px-4 py-3 text-center text-sm font-bold tracking-wider uppercase"
						>Vendedor</th
					>
					<th
						class="text-white-900 px-3 py-3 text-center text-sm font-bold tracking-wider uppercase"
						>Meta actual</th
					>
					<th
						class="text-white-900 px-5 py-3 text-center text-sm font-bold tracking-wider uppercase"
						>Alcanzado</th
					>
					<th
						class="text-white-900 px-3 py-3 text-center text-sm font-bold tracking-wider uppercase"
					...
					>
					<th
						class="text-white-900 px-6 py-3 text-center text-sm font-bold tracking-wider uppercase"
						>Meta nueva</th
					>
					<th
						class="text-white-900 px-3 py-3 text-center text-sm font-bold tracking-wider uppercase"
			...
			<tbody class="divide-y divide-gray-200 bg-white">
				{#each user as us}
					<tr class="hover:bg-gray-50">
						<td class="px-4 py-4 text-center font-semibold whitespace-nowrap text-gray-900">
							{us.Nombre}
						</td>
						<td class="px-4 py-4 text-center font-semibold whitespace-nowrap text-gray-900">
						...
						<td class="p-1">
							...
							/>
							<button
								class="text-white-900 ml-8 items-center rounded-md bg-red-800 px-4 py-2 font-semibold hover:bg-red-700"
